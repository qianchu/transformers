...
class LineByLineTextDataset(Dataset):
    ...
    def produce_tokens_para(self,tokenizer: PreTrainedTokenizer, args, file_path_src: str, file_path_tgt: str, block_size):
        ...
        tgt_examples_attention_mask=tgt_examples['attention_mask']

        return src_examples_ids,tgt_examples_ids,src_examples_attention_mask,tgt_examples_attention_mask
