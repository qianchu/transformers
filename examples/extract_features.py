...
MODELS=[XLM_R_LARGE_MIRROR,BERT_PUBMED,BERT_DE_BASE_CASED,BERT_MULTI_BASE,BERT_MULTI_LARGE,BERT,BERT_BASE_CASED,BERT_BASE_UNCASED,ROBERTA_LARGE_CASED,BERT_LARGE_CASED,XLNET_LARGE,T5,XLM,BERT_LARGE_CASED_WHOLEWORD,XLM_R_LARGE,XLM_R_BASE]
MODELNAME2MODEL={XLM_R_LARGE_MIRROR:XLMRobertaModel,BERT_PUBMED:BertModel,BERT_DE_BASE_CASED:BertModel,BERT_MULTI_LARGE:BertModel,BERT_MULTI_BASE:BertModel,BERT:BertModel,BERT_BASE_CASED:BertModel,BERT_LARGE_CASED_WHOLEWORD:BertModel,BERT_BASE_UNCASED:BertModel,BERT_LARGE_CASED:BertModel,ROBERTA_LARGE_CASED:RobertaModel,XLNET_LARGE:XLNetModel,T5:T5Model,XLM:XLMModel,XLM_R_LARGE:XLMRobertaModel,XLM_R_BASE:XLMRobertaModel}
MODELNAME2TOKENIZERS={XLM_R_LARGE_MIRROR:XLMRobertaTokenizer, BERT_PUBMED:BertTokenizer,BERT_DE_BASE_CASED:BertTokenizer,BERT_MULTI_LARGE:BertTokenizer,BERT_MULTI_BASE:BertTokenizer,BERT:BertTokenizer,BERT_BASE_CASED:BertTokenizer,BERT_LARGE_CASED_WHOLEWORD:BertTokenizer,BERT_BASE_UNCASED:BertTokenizer,BERT_LARGE_CASED:BertTokenizer, ROBERTA_LARGE_CASED:RobertaTokenizer,XLNET_LARGE:XLNetTokenizer,T5:T5Tokenizer,XLM:XLMTokenizer,XLM_R_LARGE:XLMRobertaTokenizer,XLM_R_BASE:XLMRobertaTokenizer}
EOS_NUM=1
